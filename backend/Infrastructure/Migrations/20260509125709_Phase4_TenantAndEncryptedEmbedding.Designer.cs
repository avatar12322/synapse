...
namespace Synapse.Infrastructure.Migrations
{
    ...
    [Migration("20260509125709_Phase4_TenantAndEncryptedEmbedding")]
    partial class Phase4_TenantAndEncryptedEmbedding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Synapse.Core.Models.Business.Business", b =>
                {
                    ...
                    b.Property<string>("PosWebhookSecret")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("Synapse.Core.Models.Invoice.KsefInvoice", b =>
                {
                    ...
                    b.Property<DateTime?>("UpoReceivedAt")
                        .HasColumnType("timestamp with time zone");
